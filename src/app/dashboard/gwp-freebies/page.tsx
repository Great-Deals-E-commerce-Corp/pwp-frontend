...
export default function GwpFreebiesPage() {
  ...
  const campaignType: CampaignType = 'GWP Freebies';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'gwp_freebies_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">GWP Freebies</h1>
          <p className="text-muted-foreground">
            View all GWP Freebies campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        title={"GWP Freebies Campaigns"}
        description={"A list of all GWP Freebies campaigns in the system."}
        userRole={userRole}
