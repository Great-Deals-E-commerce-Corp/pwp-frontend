...
export default function GwpSkusPage() {
  ...
  const campaignType: CampaignType = 'GWP SKUs';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'gwp_skus_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">GWP SKUs</h1>
          <p className="text-muted-foreground">
            View all GWP SKUs campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        title={"GWP SKUs Campaigns"}
        description={"A list of all GWP SKUs campaigns in the system."}
        userRole={userRole}
