...
export default function FakePricingPage() {
  ...
  const campaignType: CampaignType = 'Fake Pricing';
  ...
  const campaignsForRole = useMemo(() => {
    let campaigns = allCampaigns.filter(c => c.campaignType === campaignType);
    ...
    return campaigns;
  }, [allCampaigns, userRole, campaignType]);
  ...
  }, [campaignsForRole, searchTerm, statusFilter, brandFilter, startDateFilter, endDateFilter]);
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'fake_pricing_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Fake Pricing</h1>
          <p className="text-muted-foreground">
            View all Fake Pricing campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        title={"Fake Pricing Campaigns"}
        description={"A list of all Fake Pricing campaigns in the system."}
        userRole={userRole}
