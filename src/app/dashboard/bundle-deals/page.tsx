...
export default function BundleDealsPage() {
  ...
  const campaignType: CampaignType = 'Bundle Deals';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'bundle_deals_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            View all Bundle Deals campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        title={"Bundle Deals Campaigns"}
        description={"A list of all Bundle Deals campaigns in the system."}
        userRole={userRole}
