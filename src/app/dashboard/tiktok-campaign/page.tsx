...
export default function TiktokCampaignPage() {
  ...
  const campaignType: CampaignType = 'Tiktok Campaign';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'tiktok_campaigns_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Tiktok Campaigns</h1>
          <p className="text-muted-foreground">
            View all Tiktok campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        description={"A list of all Tiktok campaigns in the system."}
        userRole={userRole}
