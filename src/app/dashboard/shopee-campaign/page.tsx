...
export default function ShopeeCampaignPage() {
  ...
  const campaignType: CampaignType = 'Shopee Campaign';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'shopee_campaigns_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Shopee Campaigns</h1>
          <p className="text-muted-foreground">
            View all Shopee campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        description={"A list of all Shopee campaigns in the system."}
        userRole={userRole}
