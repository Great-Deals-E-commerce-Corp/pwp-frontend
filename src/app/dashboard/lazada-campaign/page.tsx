...
export default function LazadaCampaignPage() {
  ...
  const campaignType: CampaignType = 'Lazada Campaign';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'lazada_campaigns_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Lazada Campaigns</h1>
          <p className="text-muted-foreground">
            View all Lazada campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        description={"A list of all Lazada campaigns in the system."}
        userRole={userRole}
