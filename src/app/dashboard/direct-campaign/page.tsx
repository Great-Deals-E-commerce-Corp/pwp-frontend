...
export default function DirectCampaignPage() {
  ...
  const campaignType: CampaignType = 'Direct Campaign';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'direct_campaigns_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Direct Campaigns</h1>
          <p className="text-muted-foreground">
            View all Direct campaigns.
          </p>
        </div>
      ...
      <CampaignTable
        ...
        description={"A list of all Direct campaigns in the system."}
        userRole={userRole}
