...
export default function VouchersPage() {
  ...
  const campaignType: CampaignType = 'Vouchers';
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'vouchers_export.csv');
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <CampaignTable
        ...
        description={"A list of all Voucher campaigns in the system."}
        userRole={userRole}
